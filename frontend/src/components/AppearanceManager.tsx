...
const IMAGE_FIELDS: { key: keyof AppSettings["images"]; label: string; hint?: string }[] = [
  ...
  { key: "yoga", label: "Image Yoga Collectif" },
  { key: "yogaIndividuel", label: "Image Yoga Individuel", hint: "Laisser vide pour réutiliser l'image Yoga collectif" },
  { key: "pilates", label: "Image Pilates Collectif" },
  { key: "pilatesTapisIndividuel", label: "Image Pilates Individuel Tapis", hint: "Laisser vide pour réutiliser l'image Pilates collectif" },
  { key: "pilatesGaIndividuel", label: "Image Pilates Individuel G.A.", hint: "Laisser vide pour réutiliser l'image Pilates collectif" },
...
const TEXT_GROUPS: { title: string; fields: { key: string; label: string; multiline?: boolean }[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "calendarFilterPilatesCollectif", label: "Filtre 'Pilates Collectif'" },
      { key: "calendarFilterYogaCollectif", label: "Filtre 'Yoga Collectif'" },
      { key: "calendarFilterPilatesTapis", label: "Filtre 'Pilates Tapis'" },
      { key: "calendarFilterPilatesGa", label: "Filtre 'Pilates G.A.'" },
      { key: "calendarFilterYogaIndividuel", label: "Filtre 'Yoga Individuel'" },
      { key: "calendarFilterMassage", label: "Filtre 'Massages'" },
