...
const IMAGE_FIELDS: { key: keyof AppSettings["images"]; label: string; hint?: string }[] = [
  ...
  { key: "yoga", label: "Image par défaut Yoga (collectif)" },
  { key: "yogaIndividuel", label: "Image par défaut Yoga (individuel)", hint: "Laisser vide pour réutiliser l'image Yoga collectif" },
  { key: "pilates", label: "Image par défaut Pilates (générique)", hint: "Utilisée seulement si Tapis/G.A. ci-dessous sont vides" },
  { key: "pilatesIndividuel", label: "Image par défaut Pilates individuel (générique)", hint: "Utilisée seulement si Tapis/G.A. individuel ci-dessous sont vides" },
  { key: "pilatesTapis", label: "Image Pilates Tapis (collectif)", hint: "Laisser vide pour utiliser l'image Pilates générique" },
  { key: "pilatesTapisIndividuel", label: "Image Pilates Tapis (individuel)", hint: "Laisser vide pour utiliser l'image Pilates individuel générique" },
  { key: "pilatesGa", label: "Image Pilates G.A. (collectif)", hint: "Laisser vide pour utiliser l'image Pilates générique" },
  { key: "pilatesGaIndividuel", label: "Image Pilates G.A. (individuel)", hint: "Laisser vide pour utiliser l'image Pilates individuel générique" },
...
const TEXT_GROUPS: { title: string; fields: { key: string; label: string; multiline?: boolean }[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "calendarFilterPilatesTapis", label: "Filtre 'Pilates Tapis'" },
      { key: "calendarFilterPilatesGa", label: "Filtre 'Pilates G.A.'" },
