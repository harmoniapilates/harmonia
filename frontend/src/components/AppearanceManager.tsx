...
const IMAGE_FIELDS: { key: keyof AppSettings["images"]; label: string; hint?: string }[] = [
  ...
  { key: "pilates", label: "Image par défaut Pilates (collectif)" },
  { key: "pilatesIndividuel", label: "Image par défaut Pilates (individuel)", hint: "Laisser vide pour réutiliser l'image Pilates collectif" },
