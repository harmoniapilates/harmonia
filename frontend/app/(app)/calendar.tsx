...
function categoryImage(cat: string, kind?: string) {
  ...
  if (cat === "pilates_tapis") {
    return (
      (priv && images.pilatesTapisIndividuel) ||
      images.pilatesTapis ||
      (priv && images.pilatesIndividuel) ||
      images.pilates
    );
  }
  if (cat === "pilates_ga") {
    return (
      (priv && images.pilatesGaIndividuel) ||
      images.pilatesGa ||
      (priv && images.pilatesIndividuel) ||
      images.pilates
    );
  }
  if (cat === "pilates") return (priv && images.pilatesIndividuel) || images.pilates; // legacy classes
